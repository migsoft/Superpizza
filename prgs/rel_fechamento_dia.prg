...
static function relatorio()
       ...
       *-------------------*
       ...
       index on (comissao->id) to indcxtb for data == x_data
       go top
       ...
       *------------------*
       ...
       index on (comissao_mesa->id) to indcytb for data == x_data
       go top
