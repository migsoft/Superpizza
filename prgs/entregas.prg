    ...
    define window form_entrega;
        ...
        @ 005,005 browse grid_entrega;
            ...
            fontcolor BLUE
                ...
                * botões
        @ getdesktopheight()-110,005 button botao_f5;
            parent form_entrega;
        ...
        @ getdesktopheight()-110,295 button botao_f6;
            parent form_entrega;
            caption 'F6 - Mudar situação do pedido';
            width 260 height 040;
            picture 'img_situacao';
            font 'tahoma' size 010;
            bold;
            action mudar_situacao()
        @ getdesktopheight()-110,565 button botao_f9;
            parent form_entrega;
            caption 'F9 - Atualizar pedidos';
            width 210 height 040;
            picture 'img_atualiza';
            font 'tahoma' size 010;
            bold;
            action atualizar_pedidos()
        @ getdesktopheight()-110,785 button botao_esc;
            parent form_entrega;
