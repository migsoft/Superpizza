...
*------------------------------------------------------------*
        ...
        @ 217,265 button botao_confirmar_001;
            parent form_compras;
            caption 'Confirma';
            ...
            action gravar_produto()
                * botão para excluir
        @ 217,385 button botao_excluir_produto;
            parent form_compras;
            caption 'Excluir';
...
*------------------------------------------------------------*
        ...
        //                @ 230,635 getbox tbox_003_2;
            ...
            picture '@E 999,999.99'
                * botão para confirmar
        @ 217,765 button botao_confirmar_002;
            parent form_compras;
            caption 'Confirma';
            width 115 height 040;
            picture 'adicionar';
            action gravar_mprima()
                * botão para excluir
        @ 217,885 button botao_excluir_mprima;
            parent form_compras;
            caption 'Excluir';
            width 100 height 040;
            picture 'excluir_item';
...
static function atualiza_mprima()
    ...
    while .not. eof()
        add item {tmp_cpa2->id,acha_fornecedor(tmp_cpa2->fornecedor),acha_mprima(tmp_cpa2->mat_prima),trans(tmp_cpa2->qtd,;
            '@R 99,999.999'),trans(tmp_cpa2->vlr_unit,'@E 99,999.99'),trans(tmp_cpa2->qtd*tmp_cpa2->vlr_unit,'@E 999,999.99')} to grid_materia_prima of form_compras
        tmp_cpa2->(dbskip())
    end
