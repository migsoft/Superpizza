...
/*
Adapted by  : 2013 MigSoft (migsoft at oohg.org)
compilador  : harbour 3.2
lib gráfica : ooHG 5.3
*/
...
function produtos()
    ...
    define window form_produtos;
        ...
        define button button_atualizar
        picture 'atualizar'
        col 413
        row 002
        width 100
        ...
        define button button_fornecedores
    ...
    define window form_dados;
        ...
        @ 250,535 label lbl_t008;
            ...
            transparent
              ...
              * preços das pizzas
        @ 050,670 textbox tbox_preco_001;
            of form_dados;
            height 030;
            width 140;
            value x_valor_001;
            ...
            fontcolor _letra_get_1;
            picture '@E 999,999.99'
        @ 090,670 textbox tbox_preco_002;
            of form_dados;
            height 030;
            width 140;
            value x_valor_002;
            ...
            fontcolor _letra_get_1;
            picture '@E 999,999.99'
        @ 130,670 textbox tbox_preco_003;
            of form_dados;
            height 030;
            width 140;
            value x_valor_003;
            ...
            fontcolor _letra_get_1;
            picture '@E 999,999.99'
        @ 170,670 textbox tbox_preco_004;
            of form_dados;
            height 030;
            width 140;
            value x_valor_004;
            ...
            fontcolor _letra_get_1;
            picture '@E 999,999.99'
        @ 210,670 textbox tbox_preco_005;
            of form_dados;
            height 030;
            width 140;
            value x_valor_005;
            ...
            fontcolor _letra_get_1;
            picture '@E 999,999.99'
        @ 250,670 textbox tbox_preco_006;
            of form_dados;
            height 030;
            width 140;
            value x_valor_006;
...
static function pesquisar()
    ...
    while .not. eof()
        if substr(field->nome_longo,1,nTamNomePesq) == cPesq
            add item {iif(produtos->pizza,'Sim','Não'),iif(produtos->promocao,'Sim','Não'),iif(produtos->baixa,'Sim','Não'),;
                alltrim(produtos->codigo),alltrim(produtos->cbarra),alltrim(produtos->nome_longo),str(produtos->qtd_estoq,6)} to grid_produtos of form_produtos
