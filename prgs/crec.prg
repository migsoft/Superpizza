...
function crec()
    ...
    define window form_crec;
        ...
        nosize
                ...
                * botões (toolbar)
        define button button_incluir_2
        picture 'incluir'
        col 005
        row 002
        width 100
        ...
        define button button_alterar_2
        picture 'alterar'
        col 107
        row 002
        width 100
        ...
        define button button_excluir_2
        picture 'excluir'
        col 209
        row 002
        width 100
        ...
        define button button_atualizar_2
        picture 'atualizar'
        col 311
        row 002
        width 100
        ...
        @ 610,280 datepicker dp_final_2;
            ...
            width 100;
            font 'verdana' size 010
        @ 610,390 button botao_filtrar_2;
            parent form_crec;
            caption 'Filtrar';
...
static function atualizar_crec()
    ...
    while .not. eof()
        add item {contas_receber->id,dtoc(contas_receber->data),acha_cliente(contas_receber->cliente),acha_forma_recebimento(contas_receber->forma),;
            trans(contas_receber->valor,'@E 999,999.99'),alltrim(contas_receber->numero),alltrim(contas_receber->obs)} to grid_crec of form_crec
