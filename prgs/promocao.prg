    ...
    define window form_promocao;
        ...
        @ 010,220 label lbl_reajuste;
            ...
            transparent
                ...
                * botões
        @ 520,250 button botao_excluir_promocao;
            parent form_promocao;
...
static function filtrar_informacoes_2()
    ...
    while .not. eof()
        if x_tipo == 1                              //pizzas
            add item {tmp_reajuste->cod_prod,tmp_reajuste->nom_prod,trans(tmp_reajuste->tam_001,'@E 99,999.99'),trans(tmp_reajuste->tam_002,;
                '@E 99,999.99'),trans(tmp_reajuste->tam_003,'@E 99,999.99'),trans(tmp_reajuste->tam_004,'@E 99,999.99'),trans(tmp_reajuste->tam_005,;
                '@E 99,999.99'),trans(tmp_reajuste->tam_006,'@E 99,999.99')} to grid_promocao of form_promocao
        elseif x_tipo == 2                          //demais produtos
