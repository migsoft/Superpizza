...
static function acesso()
    ...
    define window form_acesso;
        ...
        page 'Relatórios' image 'img_tres'
        ...
        page 'Financeiro' image 'img_quatro'
        ...
        page 'Ferramentas' image 'img_cinco'
